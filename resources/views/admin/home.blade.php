                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <h3 class="text-dark mt-1 mb-0">{{ $total_stu }}</h3>
                            </div> <!-- end col -->
                    </div> <!-- end row-->
                </div> <!-- end card body -->
            </div> <!-- end card -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <p class="text-muted mb-0 text-truncate">Total Classes</p>
                                <h3 class="text-dark mt-1 mb-0">{{ $total_class }}</h3>
                            </div> <!-- end col -->
                    </div> <!-- end row-->
                </div> <!-- end card body -->
            </div> <!-- end card -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <p class="text-muted mb-0 text-truncate">Total Teachers</p>
                                <h3 class="text-dark mt-1 mb-0">{{ $total_teachers }}</h3>
                            </div> <!-- end col -->
                    </div> <!-- end row-->
                </div> <!-- end card body -->
            </div> <!-- end card -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <p class="text-muted mb-0 text-truncate">Total Subjects</p>
                                <h3 class="text-dark mt-1 mb-0">{{ $total_sub }}</h3>
                            </div> <!-- end col -->
                    </div> <!-- end row-->
                </div> <!-- end card body -->
            </div> <!-- end card -->
