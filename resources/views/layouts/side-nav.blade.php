<div class="main-nav">
     ...
     <div class="logo-box">
          <a href="#" class="logo-light">
               <img src="{{ asset('logo/edu-logo.jpg')}}" class="logo-sm" alt="logo sm">
          </a>
     </div>
     ...
     <div class="scrollbar" data-simplebar>
          ...
          <ul class="navbar-nav" id="navbar-nav">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="/grade-subject">
                         <span class="nav-icon">
                              <iconify-icon icon="solar:siderbar-broken"></iconify-icon>
                         </span>
                         <span class="nav-text"> Subjects / Grades </span>
                    </a>
               </li>
               ...
               <li class="nav-item">
                    <a class="nav-link" href="/class/payments">
                         <span class="nav-icon">
                              <iconify-icon icon="solar:siderbar-broken"></iconify-icon>
                         </span>
